...
export function SpaceSelectSheet({
  activeSpace,
  onSelect,
  onClose,
  onNewSpace,
  onEditSpace,
}: SpaceSelectSheetProps) {
  return (
    <div className="absolute inset-0 z-[80]" onClick={onClose}>
      ...
      />
      <div
        className="absolute bottom-0 left-0 right-0 rounded-t-3xl pt-2 pb-8 premium-sheet-panel"
        style={{
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 mb-4">
          ...
          <button
            className="ios-tap flex items-center gap-1 rounded-lg px-3 py-1.5"
            style={{ background: "var(--premium-surface-selected)" }}
            onClick={() => {
              onClose();
              onEditSpace();
            }}
          ...
          >
            ...
            <span
              className="font-semibold text-[#2563FF]"
              style={{ fontSize: 12 }}
            >
              编辑
            </span>
                ...
                >
                  ...
                  {isActive && (
                    <Check
                      size={18}
                      strokeWidth={2.5}
                      style={{ color: "#4C6FFF", flexShrink: 0, marginTop: 4 }}
                    />
                  )}
                </button>
              );
        ...
        <div className="px-4">
          <div
            ...
            style={{ background: "var(--premium-callout-bg)" }}
          >
            <span style={{ fontSize: 15 }}>💡</span>
            <p
              className="leading-relaxed"
              style={{ fontSize: 12, color: "var(--premium-callout-text)" }}
            >
              免费版支持 1 个资料箱，升级 Pro 可创建多个资料箱并解锁完整功能
            </p>
          </div>
        </div>
      </div>
