...
// "record" = top record menu, "attachment-menu" = attachment menu, "remove-confirm" = remove confirm for attachment
  ...
  const thumbnailForType = (type: AttachmentKind) => {
    if (type === "pdf")
      return {
        ...
        icon: <FileText size={18} className="text-[#FF3B30]" />,
        badge: "PDF",
        badgeColor: "#FF3B30",
      };
    if (type === "video")
      return {
        ...
        icon: (
          <span style={{ fontSize: 14, color: "#7C5CFF", fontWeight: 700 }}>
            ▶
          </span>
        ),
        badge: "视频",
    ...
    if (type === "live")
      return {
        bg: "var(--premium-warning-bg)",
        icon: (
          <span style={{ fontSize: 14, color: "#CC9500", fontWeight: 700 }}>
            ◎
          </span>
        ),
        badge: "实况",
      ...
      <div className="relative z-10 flex-1 overflow-y-auto hide-scrollbar pb-10">
        ...
        {showSaveFail && (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p
                className="mt-0.5"
                style={{ fontSize: 12, color: "var(--premium-danger-text)" }}
              >
                请检查权限或剩余存储空间
              </p>
            </div>
        ...
        <div className="px-4 mb-4">
          <PremiumCard
            ...
            style={{
              ...
              boxShadow: "0 18px 42px rgba(76,111,255,0.18)",
            }}
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 86% 8%, rgba(255,255,255,0.24), transparent 38%)",
              }}
            />
            <div className="relative">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  <span
                    className="inline-flex px-2 py-0.5 rounded-md font-semibold mb-2"
                    style={{
                      fontSize: 12,
                  ...
                  <p className="text-white/72 mt-1" style={{ fontSize: 13 }}>
                    2026年5月12日 · Apple Store 上海
                  </p>
                </div>
                <div
              ...
              <div className="mt-5 grid grid-cols-3 gap-2">
                {[
                  ...
                  >
                    ...
                    <p className="text-white/68" style={{ fontSize: 10 }}>
                      {item.label}
                    </p>
                  </div>
                ))}
        ...
        <div className="px-4 mb-4">
          <PremiumCard className="rounded-[18px] px-4 py-4">
            ...
            >
              MacBook Pro 14 英寸，M4 Pro 芯片，2026 年 5 月购入，Apple One Year
              保修到 2027-09-12。序列号：FVFXXX123。
            </p>
            <div className="pt-3 flex flex-wrap gap-1.5">
              <span
                ...
                style={{
                  fontSize: 12,
                  background: "var(--premium-icon-neutral-bg)",
        ...
        <div className="px-4 mb-4">
          ...
          {attachments.length === 0 ? (
            <PremiumCard className="rounded-[18px] px-4 py-5 text-center">
              <p style={{ fontSize: 14, color: "var(--premium-text-subtle)" }}>
                暂无附件
              </p>
            </PremiumCard>
          ) : (
        ...
        >
          <div className="flex flex-col items-center text-center px-5 mb-5">
            ...
            <p
              ...
              style={{ fontSize: 14, color: "var(--premium-text-muted)" }}
            >
...
function SheetOverlay({
  ...
  return (
    <div className="absolute inset-0 z-[80]" onClick={onDismiss}>
      <div
        className="absolute inset-0 premium-sheet-overlay"
        style={{ background: "var(--premium-overlay)" }}
      />
      <div
        className="absolute bottom-0 left-0 right-0 rounded-t-3xl pb-10 pt-2 premium-sheet-panel"
        style={{
