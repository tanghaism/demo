      ...
      >
        ...
        {onClick && (
          <ChevronRight
            size={16}
            strokeWidth={2}
            style={{ color: "var(--premium-chevron)", flexShrink: 0 }}
          />
        )}
      </div>
    </button>
...
export function SettingsScreen({ onNavigate }: SettingsScreenProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex-1 overflow-y-auto hide-scrollbar pb-24">
          ...
          {proExpired ? (
            ...
            >
              <AlertCircle
                size={16}
                strokeWidth={2}
                style={{ color: "#FF9500", marginTop: 1, flexShrink: 0 }}
              />
              <div className="flex-1">
                <p
                  style={{
                    fontSize: 14,
                    fontWeight: 600,
                    color: "var(--premium-warning-text)",
                  }}
                >
                  Pro 订阅已到期
                </p>
            ...
            >
              ...
              <div className="relative flex items-center justify-between">
                ...
                >
                  <span
                    style={{ fontSize: 14, fontWeight: 600, color: "#4C6FFF" }}
                  >
                    开通 Pro
                  </span>
                </div>
          ...
          >
            <div className="flex items-start px-4 py-3.5">
              ...
              >
                ...
                >
                  所有资料仅保存在您的 iPhone 上，不上传至任何服务器，不接入广告
                  SDK。
                </p>
              </div>
            </div>
        ...
        <div className="px-4 mb-3">
          ...
          >
            ...
            >
              <span style={{ fontSize: 16, color: "var(--premium-text)" }}>
                Proofly
              </span>
              <span
                style={{ fontSize: 16, color: "var(--premium-text-subtle)" }}
              >
                v1.0.0
              </span>
            </div>
      ...
      {showBackupSheet && (
        ...
        >
          ...
          >
            ...
            <div
              className="mb-5 mx-4 flex items-start gap-3 px-4 py-3 rounded-xl"
              style={{
                background: "var(--premium-success-bg)",
            ...
            >
              <Fingerprint
                size={14}
                strokeWidth={2}
                style={{ color: "#14C8A8", flexShrink: 0, marginTop: 1 }}
              />
              <div>
                <p
                  style={{
                ...
                >
                  备份文件以 .proofly-backup 格式保存，使用 Face ID
                  和密码双重加密，无法在外部直接查看。
                </p>
              </div>
            </div>
            ...
            {backupDone ? (
              <div
                ...
                style={{
                  height: 50,
                  background: "var(--premium-success-bg)",
                  border: "1px solid var(--premium-success-border)",
                }}
              >
                <Check
                  size={18}
              ...
              <button
                ...
                style={{ height: 50, background: "#2563FF" }}
          ...
          >
            ...
            {restoreStep === "picker" && (
              <>
                ...
                <p
                  className="px-5 mb-4 leading-snug"
                  style={{ fontSize: 14, color: "var(--premium-text-subtle)" }}
                >
                  从「文件」App 中选择 .proofly-backup 格式的备份文件
                </p>
                <div className="px-4 flex flex-col gap-2 mb-2">
                  {[
                    {
                      name: "backup_2026-05-09.proofly-backup",
                      date: "2026-05-09",
                      size: "42.6 MB",
                      records: 46,
                      attachments: 38,
                    ...
                    {
                      name: "backup_2026-04-15.proofly-backup",
                      date: "2026-04-15",
                      size: "38.2 MB",
                      records: 41,
                      attachments: 32,
                    ...
                    <button
                      key={f.name}
                      className="ios-tap w-full flex items-center gap-3 px-4 py-3.5 rounded-xl text-left"
                      style={{ background: "var(--premium-surface-soft)" }}
                      onClick={() => setRestoreStep("faceid")}
                      aria-label={f.name}
                    >
                      <div
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        >
                          {f.records} 条记录 · {f.attachments} 个附件 · {f.size}{" "}
                          · {f.date}
                        </p>
                      </div>
                      <span
                ...
                <div className="px-4 mb-2">
                  <button
                    className="ios-tap w-full flex items-center justify-center gap-2 rounded-xl py-3"
                    style={{ border: "1.5px dashed var(--premium-row-border)" }}
                    aria-label="浏览文件"
                  >
                    <span
                      style={{
            ...
            {restoreStep === "faceid" && (
              <>
                <div className="flex flex-col items-center text-center px-5 mb-5">
                  ...
                  >
                    备份文件已加密，需要使用 Face ID 或输入备份密码来解密
                  </p>
                </div>
                <div className="px-4 mb-4">
                  ...
                  >
                    <button
                      className="ios-tap w-full flex items-center justify-between px-4 py-4"
                      style={{
                        borderBottom: "0.5px solid var(--premium-row-border)",
                      }}
              ...
              <>
                ...
                >
                  <p
                    ...
                    style={{ fontSize: 14, color: "var(--premium-text)" }}
                  >
                    backup_2026-05-09.proofly-backup
                  </p>
                  <p
                    className="mt-1"
                    style={{
                  ...
                  >
                    46 条记录 · 38 个附件 · 3 个空间 · 2026-05-09
                  </p>
                </div>
                <div
                  className="mb-3 mx-4 flex items-start gap-2.5 px-4 py-3"
                  style={{
      ...
      {showTrashSheet && (
        <SettingsInfoSheet
          onDismiss={() => setShowTrashSheet(false)}
          title="回收站"
        >
          <p
            style={{
          ...
          <div className="px-4 mt-4">
            ...
            >
              {[
                ...
                >
                  <span style={{ fontSize: 15, color: "var(--premium-text)" }}>
                    {item}
                  </span>
                  <button
                    className="ios-tap"
                    style={{ fontSize: 15, color: "#4C6FFF", fontWeight: 600 }}
                  >
                    恢复
                  </button>
                </div>
      ...
      {showPrivacySheet && (
        <SettingsInfoSheet
          onDismiss={() => setShowPrivacySheet(false)}
          title="隐私政策"
        >
          <div className="px-5 flex flex-col gap-4">
            {[
              [
                "数据本地化",
                "所有数据仅存储在您的设备本地，不上传至任何服务器。",
              ],
              [
                "不收集个人信息",
                "我们不收集您的姓名、手机号或任何可识别信息。",
              ],
              ["无广告 SDK", "App 内不嵌入任何广告 SDK 或行为追踪代码。"],
              [
                "附件安全",
                "导入的 PDF 和图片仅保存于 App 沙盒，不被读取或分析。",
              ],
            ].map(([title, body]) => (
              <div key={title}>
                <p
      ...
      {showDisclaimerSheet && (
        <SettingsInfoSheet
          onDismiss={() => setShowDisclaimerSheet(false)}
          title="免责声明"
        >
          <p
            style={{
          ...
          >
            Proofly
            仅为个人资料整理工具，所生成的资料包不构成法律证明、税务凭证、保险理赔依据或任何正式法律文件。如需正式证明，请向相关机构申请原始文件。
          </p>
          <p
            style={{
              fontSize: 14,
      ...
      >
        ...
        <div className="px-4 mt-5">
          ...
          <button
            ...
            aria-label="关闭"
          >
            <span style={{ fontSize: 17, fontWeight: 600, color: "#4C6FFF" }}>
              关闭
            </span>
          </button>
        </div>
