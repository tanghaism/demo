      ...
      <div className="relative z-10 flex-1 overflow-y-auto hide-scrollbar pb-10">
        ...
        <div className="px-4 mb-4">
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              >
                <p
                  className="font-bold text-[#4C6FFF]"
                  style={{ fontSize: 20 }}
                >
                  {s.value}
                </p>
                <p style={{ fontSize: 12, color: "var(--premium-text-muted)" }}>
                  {s.label}
                </p>
              </PremiumCard>
            ))}
        ...
        <div className="px-4 mb-4">
          <PremiumCard
            ...
            style={{ border: "1px solid var(--premium-warning-border)" }}
          >
            ...
            <div className="relative pl-5">
              ...
              <div
                ...
                style={{
                  bottom: 8,
                  width: 1,
                  background: "var(--premium-row-border)",
                }}
              />
        ...
        <div className="px-4 pb-2">
          <button
            ...
            style={{
              ...
              color: "#FFFFFF",
              minHeight: 50,
              boxShadow: "0 14px 28px rgba(76,111,255,0.22)",
            }}
          ...
          >
            ...
            >
              <AlertCircle
                ...
                style={{ color: "var(--premium-danger-text)" }}
              />
              <p
                className="leading-snug"
                style={{ fontSize: 13, color: "var(--premium-danger-text)" }}
              >
                删除对象后，已有记录不会被删除，但会取消与该对象的关联。
              </p>
            </div>
